package ord.example.homework.four;

import ord.example.homework.four.ex1.Bus;
import ord.example.homework.four.ex1.Car;
import ord.example.homework.four.ex1.CarWash;
import ord.example.homework.four.ex1.PassengerCar;
import ord.example.homework.four.ex2.Airplane;
import ord.example.homework.four.ex2.Duck;
import ord.example.homework.four.ex2.FlyException;
import ord.example.homework.four.ex2.Flyable;
import ord.example.homework.four.ex3.*;
...
public class Homework4 {
    ...
    public static void ex1() {
        ...
        PassengerCar passengerCar1 = new PassengerCar(false, 5, 2, 1.8, true);
        PassengerCar passengerCar2 = new PassengerCar(false, 5, 2, 1.8, false);
        PassengerCar passengerCar3 = new PassengerCar(false, 5, 2, 1.8, false);
        PassengerCar passengerCar4 = new PassengerCar(false, 5, 2, 1.8, true);
        Bus bus1 = new Bus(false, 12, 3, 2.3, 25);
        Bus bus2 = new Bus(false, 12, 3, 2.3, 12);
        Bus bus3 = new Bus(false, 12, 3, 2.3, 40);
        Bus bus4 = new Bus(false, 12, 3, 2.3, 30);
        Bus bus5 = new Bus(false, 12, 3, 2.3, 60);
        System.out.println(CarWash.clearCars(new Car[]{bus1, bus2, bus3, bus4, bus5,
    ...
    public static void ex2() {
        ...
        Flyable[] flyables = new Flyable[] {duck1, duck2, airplane1, airplane2};
